/*******************************************************************
* Main CPP for vexMotor library modified for Timer2. Uses the
* ServoTimer2 library and scales an input power (-255 to +255) to a
* pulse width for the VEX motor controller.
*
* Positive values rotate the motor CW, negative values rotate the
* motor CCW.
*
* 22 Dec 2014 - Brian Huang, SparkFun Electronics
* 20 Jan 2015 - John Ott
